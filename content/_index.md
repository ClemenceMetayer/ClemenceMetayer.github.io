...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        - Latest paper: *Data-driven discovery of digital twins in biomedical research* (Briefings in Bioinformatics, 2026).
        - Upcoming conference: Society for Mathematical Biology Annual Meeting 2026 (invited talk), Graz, Austria, July 2026.
    design:
      columns: '1'
  - block: markdown
    content:
